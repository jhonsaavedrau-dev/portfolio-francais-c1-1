/* PetitChat — service worker (v1.5.0-9619f7e1) */
const CORE="pc-core-1.5.0-9619f7e1", AUDIO="pc-audio-1";
const PRECACHE=["./", "index.html", "carnet.html", "manifest.webmanifest", "privacy.html", "icons/icon-192.png", "icons/icon-512.png", "icons/maskable-512.png", "icons/apple-touch-icon.png", "icons/favicon-32.png", "img/atras.webp", "img/b-bronce.webp", "img/b-diamante.webp", "img/b-legendario.webp", "img/b-oro.webp", "img/b-plata.webp", "img/bg-biblioteca.webp", "img/bg-cafe.webp", "img/bg-montana.webp", "img/bg-noche.webp", "img/bg-paris.webp", "img/bg-playa.webp", "img/bg-universidad.webp", "img/bloqueado.webp", "img/calendario.webp", "img/card-dia.webp", "img/card-noche.webp", "img/completado.webp", "img/conversacion.webp", "img/crown.webp", "img/d-bench.webp", "img/d-bridge.webp", "img/d-cloud.webp", "img/d-flowers.webp", "img/d-lamp.webp", "img/d-leaves.webp", "img/d-sign.webp", "img/d-sparkle.webp", "img/d-trees.webp", "img/dificil.webp", "img/encurso.webp", "img/escritura.webp", "img/escucha.webp", "img/estrella.webp", "img/facil.webp", "img/favorito.webp", "img/flame.webp", "img/gear.webp", "img/gem.webp", "img/gramatica.webp", "img/guardar.webp", "img/hito.webp", "img/home.webp", "img/lecciones.webp", "img/lectura.webp", "img/logro.webp", "img/m-actualidad.webp", "img/m-cafe.webp", "img/m-cultura.webp", "img/m-francia.webp", "img/m-inicio.webp", "img/m-trabajo.webp", "img/m-viajes.webp", "img/mascota.webp", "img/media.webp", "img/music.webp", "img/pausa.webp", "img/perfil.webp", "img/regalo.webp", "img/repetir.webp", "img/reto.webp", "img/retos.webp", "img/siguiente.webp", "img/stats.webp", "img/tienda.webp", "img/vida-off.webp", "img/vida.webp"];
